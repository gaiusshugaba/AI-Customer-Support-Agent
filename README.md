...
\- \*\*RLS-hardened admin console\*\* — `ingestion\_log` and `request\_errors` are readable by the public anon key while remaining write-restricted to the service role.
